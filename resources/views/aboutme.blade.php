  ...
  <div class="hero-content flex flex-col lg:flex-row items-center gap-8 px-4">
    ...
    <div>
      ...
      <p class="py-6 text-center text-3xl">
        Ciao piacere di conoscerti sono  Gaspare D'Antone. Da sempre ho avuto una forte passione per tutto quello che riguarda le nuove tecnlogie Hardware e Software è questo mi ha portato durante le mie esperienze lavorative ad occuparmi anche dell'assemblaggio Pc,ma recentemente ho investito il mio tempo e le mia passione in un corso per acquisire le competenze necessarie per diventare un Junior Full Stack Web Developer 
      </p>
