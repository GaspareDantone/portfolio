...
<x-main>
  ...
  <div class="hero-content flex-col lg:flex-row-reverse ">
    ...
    <div class=" text-center">
      ...
      <a href="{{ route('downloadcv')}}" class="btn btn-outline btn-info">Download CV</a>
      <a href="https://www.linkedin.com/in/gaspare-d-antone-465168138/" target="_blank" class="btn btn-outline btn-info">Linkedin</a>
    </div>
  </div>
  </div>
  <!-- fine hero section -->
